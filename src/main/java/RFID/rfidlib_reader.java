...
public class rfidlib_reader {
	...
	public native static int RDR_ParseTagDataReportRaw(long hr, byte[] byData, Integer len);
	
	public native static int RDR_SetInvenStopTrigger(long hInvenParams, byte stopTriggerType, int maxTimeout, int triggerValue);
